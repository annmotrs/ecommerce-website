  ...
  <section class="orders container">
    ...
    <?php 
          try {
            ...
            //Выборка всех заказов со статусами "выполнен", "отменен интернет-магазином", "отменен пользователем"
            $select_orders = $conn->prepare('SELECT *, orders.id AS order_id FROM shop_db.orders 
                                              ...
                                              WHERE shop_db.orders.status = "отменен интернет-магазином" OR shop_db.orders.status = "отменен пользователем" OR shop_db.orders.status = "выполнен"
      ...
      <div class="orders__card">
        ...
        <p class="orders__card-property">Статус заказа: <span class="orders__card-value <?= $select_orders_array_row['status'] === "выполнен" ? "orders__card-value--color_green" : "orders__card-value--color_red" ?>"><?= $select_orders_array_row['status']; ?></span></p>
