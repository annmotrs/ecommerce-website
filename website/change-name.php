...
<body>
  ...
  <section class="change-user-data">
    <div class="change-user-data__wrapper">
      <h1 class="change-user-data__title">Редактирование имени</h1>
      <form action="for-change-name.php" method="POST">
        <p><label class="change-user-data__label" for="name">Новое имя:</label></p>
        ...
        <p><input class="change-user-data__input" type="text" name="new-name" id="name" pattern="^[А-Яа-яЁё]+$" title="Имя должно быть только с использованием русских букв." value="<?= $select_user_array['name']; ?>" required></p>  
