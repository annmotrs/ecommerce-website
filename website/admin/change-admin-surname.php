...
<body>
  ...
  <section class="admin-data">
    <div class="admin-data__wrapper">
      <h1 class="admin-data__title title">Редактирование фамилии</h1>
      <form action="for-change-admin-surname.php" method="POST">
        <p><label class="admin-data__label" for="surname">Новая фамилия:</label></p>
      ...
      ?>
        ...
        <p><input class="admin-data__input" type="text" name="new-surname" id="surname" pattern="^[А-Яа-яЁё]+$" title="Фамилия должна быть только с использованием русских букв." value="<?= $select_admin_array['surname']; ?>" required></p>  
