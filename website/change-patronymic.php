...
<body>
  ...
  <section class="change-user-data">
    <div class="change-user-data__wrapper">
      <h1 class="change-user-data__title">Редактирование отчества</h1>
      <form action="for-change-patronymic.php" method="POST">
        <p><label class="change-user-data__label" for="patronymic">Новое отчество:</label></p>
        ...
        <p><input class="change-user-data__input" type="text" name="new-patronymic" id="patronymic" pattern="^[А-Яа-яЁё]+$" title="Отчество должно быть только с использованием русских букв." value="<?= $select_user_array['patronymic']; ?>" required></p>  
        ...
        <div class="change-user-data__box-button">
          <button type="submit" class="button" name="change-patronymic">Сохранить</button>
        </div>
      </form>
