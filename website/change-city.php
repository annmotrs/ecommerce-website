...
<body>
  ...
  <section class="change-user-data">
    <div class="change-user-data__wrapper">
      <h1 class="change-user-data__title">Редактирование города</h1>
      <form action="for-change-city.php" method="POST">
        <p><label class="change-user-data__label" for="city">Новый город:</label></p>
        ...
        <p><input class="change-user-data__input" type="text" name="new-city" id="city" pattern="^[А-Яа-яЁё]+$" title="Город должен быть только с использованием русских букв." value="<?= $select_user_array['city']; ?>" required></p>  
        ...
        <div class="change-user-data__box-button">
          <button type="submit" class="button" name="change-city">Сохранить</button>
        </div>
      </form>
