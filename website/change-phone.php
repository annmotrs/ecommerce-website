...
<body>
  ...
  <section class="change-user-data">
    <div class="change-user-data__wrapper">
      <h1 class="change-user-data__title">Редактирование телефона</h1>
      <form action="for-change-phone.php" method="POST">
        <p><label class="change-user-data__label" for="phone">Новый телефон:</label></p>
        ...
        <p><input class="change-user-data__input" type="tel" name="new-phone" id="phone" value="<?= $select_user_array['phone']; ?>" required></p> 
        ...
        <div class="change-user-data__box-button">
          <button type="submit" class="button" name="change-phone">Сохранить</button>
        </div>
      </form>
