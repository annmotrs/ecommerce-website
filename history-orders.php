...
<body>
  ...
  <section class="orders">
    <div class="orders__wrapper">
      <h1 class="orders__title">История заказов</h1>
        ...
        <?php
          try {
            ...
            //Выборка всех заказов авторизованного пользователя по его id
            $select_orders = $conn->prepare('SELECT * FROM shop_db.orders WHERE user_id=:user_id ORDER BY date_order DESC');
        ...
        ?>
          ...
          <?php      
              ...
              echo '<h1 class="orders__message">Заказов не было</h1>';
            } 
          }
